 ...
 */
function ye_customize( $wp_customize ) {
	/**
	 * Initialize sections
	 */
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			'header_logo',
			array(
				'label'       => __( 'Upload Header Logo', 'ye' ),
				'description' => __( 'Height: &gt;80px', 'ye' ),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'label'    => __( 'Navbar Scheme', 'ye' ),
			'section'  => 'theme_header_section',
			'choices'  => array(
				'navbar-light bg-light'  => __( 'Default', 'ye' ),
				'navbar-dark bg-dark'    => __( 'Dark', 'ye' ),
				'navbar-dark bg-primary' => __( 'Primary', 'ye' ),
			),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'choices'  => array(
				'static'       => __( 'Static', 'ye' ),
				'fixed_top'    => __( 'Fixed to top', 'ye' ),
				'fixed_bottom' => __( 'Fixed to bottom', 'ye' ),
			),
...
add_action( 'customize_register', 'ye_customize' );


/**
 * Bind JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function ye_customize_preview_js() {
	wp_enqueue_script( 'customizer', get_template_directory_uri() . '/inc/customizer.js', array( 'jquery' ), null, true );
}
add_action( 'customize_preview_init', 'ye_customize_preview_js' );
